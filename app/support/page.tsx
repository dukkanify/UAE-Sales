...
const faqs = [
  ...
  {
    q: "كيف أفتح نزاعًا؟",
    a: "من لوحة التحكم اختر النزاعات، أو من تفاصيل الطلب اضغط «فتح النزاع». حدّد السبب خلال مهلة الفتح، وسيُخطر البائع والإدارة فوراً.",
  },
  {
    q: "كيف أنشر إعلانًا؟",
...
const shortcuts = [
  ...
  { href: "/dashboard/disputes", label: "فتح نزاع" },
