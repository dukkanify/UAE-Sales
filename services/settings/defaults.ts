...
export const DEFAULT_PLATFORM_SETTINGS: PlatformSettings = {
  ...
  branding: {
    logoUrl: "/brand/logo.png?v=option-a-2",
    darkLogoUrl: "/brand/logo-dark.png?v=option-a-2",
    faviconUrl: "/brand/favicon.svg?v=option-a-2",
    loginBackgroundUrl: "/images/hero-aviation.svg",
    loginIllustrationUrl: "/images/hero-aviation.svg",
    openGraphImageUrl: "/brand/og.png?v=option-a-2",
    primaryColor: "#2E7DAA",
