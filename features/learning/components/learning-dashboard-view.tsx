...
type LearningDashboardViewProps = {
  overview: LearningDashboardOverview;
};

function LearningDashboardView({ overview }: LearningDashboardViewProps) {
        ...
        <Card className="overflow-hidden border-primary/20 bg-gradient-to-br from-primary/5 via-background to-background">
          <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">{overview.resume.courseTitle}</p>
            </div>
