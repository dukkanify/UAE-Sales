...
const dashboardLinks = [
  ...
  { href: "/dashboard/bookings", icon: "map" as const, label: "الحجوزات" },
  { href: "/dashboard/quotes", icon: "wrench" as const, label: "الخدمات" },
  { href: "/dashboard/applications", icon: "briefcase" as const, label: "الوظائف" },
