...
export function HeroEscrowBadge() {
  return (
    <div
      aria-hidden
      className="hero-float-slow absolute -bottom-2 end-4 z-30 hidden rounded-[var(--radius-2xl)] border border-secondary/25 bg-white/92 px-4 py-3 shadow-[var(--shadow-lg)] backdrop-blur-md sm:flex lg:end-8"
    >
