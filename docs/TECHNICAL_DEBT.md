...
| TD-012 | CSRF on all cookie-authenticated mutations        | high     | CSRF gaps on older routes      | Extend `api-guard` coverage                  | M      | v1.8   | in_progress | Bookings + payment orders guarded 2026-08-25 |
