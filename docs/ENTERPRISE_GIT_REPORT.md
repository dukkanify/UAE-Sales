...
| Field                          | Value                                                         |
| ------------------------------ | ------------------------------------------------------------- |
| Remote origin                  | `https://x-access-token:***@github.com/dukkanify/AviatorPass` |
...
| Latest workflow run        | completed / success — https://github.com/dukkanify/AviatorPass/actions/runs/32761452206 |
