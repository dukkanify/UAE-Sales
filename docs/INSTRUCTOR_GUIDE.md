...
- Open **Wallet** to review earnings and payout status (Stripe Connect when live).
...
- Post announcements, answer messages, and participate in communities.

## Support

Escalate account, Zoom, or payout issues to an Admin / Super Admin.
