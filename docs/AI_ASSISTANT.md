...
Task 014 delivers a secure, role-aware AI assistant for ATPL PASS. Responses are **grounded** in platform data (enrollments, progress, classes, analytics). The provider layer is deterministic/mock today and designed for future LLM upgrades.
